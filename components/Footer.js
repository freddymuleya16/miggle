...
export const Footer = () => {
    return (
        <footer className="pt-4 px-8   text-white">
            <section className="container mx-auto px-8 pt-16">
                <div className="flex flex-col items-center  ">
                    <div className=" container mx-auto px-8   pt-16   sm:max-w-xl md:max-w-full    md:px-24 lg:px-4 ">
